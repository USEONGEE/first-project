...
excelFilePath = 'C:/Users/shdbt/Desktop/22년도 학술제/부산_강서구_노인복지시설.xlsx'
sheet = 'Sheet2'
...
excelData = getExcelData(excelFilePath,sheet,'F3','F24')
# excelData = preprocess(excelData)
# excelData_separated = separateData_by100(excelData)
# print(excelData_separated[0])

# //CROWLING//

number = int(input('type a number under or same len_\n'))
fileName = '부산_강서구_노인복지시설'
fileNumber = number
